...
namespace Com.Kawaiisun.SimpleHostile
{
    ...
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        public void Create ()
        {
            ...
            properties.Add("duration", (int)maxDurationSlider.value);
            options.CustomRoomProperties = properties;
            Manager.matchLength = (int)maxDurationSlider.value * 60;
            Debug.Log("match duration is " + Manager.matchLength);
        ...
        public void ChangeMaxDurationSlider()
        {
            maxDurationValue.text = Mathf.RoundToInt(maxDurationSlider.value).ToString();
        }
        ...
        public void TabOpenCreate ()
        {
            ...
            maxDurationSlider.value = maxDurationSlider.maxValue;
            maxDurationValue.text = Mathf.RoundToInt(maxDurationSlider.value).ToString();
        }
        ...
        public void LoadGameSettings (RoomInfo roomInfo)
        {
            ...
            //Manager.matchLength = (int)roomInfo.CustomProperties["duration"];
            //Debug.Log("match duration is "+ Manager.matchLength);
        }
